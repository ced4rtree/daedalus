...
- [[#clean-up][Clean Up]]
  ...
  - [[#guix-packages-installation][Guix Packages Installation]]
...
** Direnv
In environments like Nix and Guix, it's pretty useful to automatically enter
your dev environment when you open a project, which is what direnv does.
...
** Geiser
Geiser is a helpful lisp repl for emacs that lets you debug lisp
code by evaluating the expression from within emacs. Very helpful for
debugging my guix config!
...
** Paredit
Editing source text by hand is for barbarians. Us civilized folk
manipulate the source tree directly with paredit.
...
** VTerm
A proper terminal inside emacs
...
** Guix
GNU Guix already lets me configure my operating system with lisp, and
now I never have to leave emacs to do it!
...
** Guix Packages Installation
All of the above packages that are used also define the guix package
they use, and are installed below:

#+begin_src scheme :tangle ../../../services/emacs.scm :noweb yes
