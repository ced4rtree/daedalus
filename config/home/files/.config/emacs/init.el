...
(use-package stumpwm-mode :defer t)
(use-package cmake-mode :defer t)

(use-package geiser-guile
  ;; ~/.dotfiles is where my guix config lives
  :defer t
...
(use-package paredit
  :defer t
  :hook ((emacs-lisp-mode scheme-mode guix-scheme-mode lisp-mode common-lisp-mode) . paredit-mode))

(use-package vterm
  :commands vterm
  :defer t
  :ensure nil) ;; vterm is installed by guix
...
(use-package visual-fill-column
  ...
  :commands (visual-fill-column-mode
             cedar/enable-center-text
             cedar/disable-center-text
             cedar/toggle-center-text)
  :config
  (defun cedar/enable-center-text ()
    "Enables centered text in org mode."
    (interactive)
    (visual-fill-column-mode t)
    (setq visual-fill-column-center-text t))

  (defun cedar/disable-center-text ()
    "Disables centered text in org mode."
    (interactive)
    (visual-fill-column-mode nil)
    (setq visual-fill-column-center-text nil))

  (defun cedar/toggle-center-text ()
