...
#else
static const char *fonts[]               = { "Iosevka Nerd Font Mono:size=12", "Noto Color Emoji:size=10" };
...
static const char* musPause[] = { "emacsclient", "-e", "(emms-pause)", "||", "mpc", "toggle", NULL };
static const char* musNext[] = { "mpc", "next", NULL };
static const char* musPrev[] = { "mpc", "prev", NULL };
static const char* sndDown[] = { "snd", "down", NULL };
static const char* sndUp[] = { "snd", "up", NULL };
static const char* brightUp[] = { "real-brightness", "up", NULL };
static const char* brightDown[] = { "real-brightness", "down", NULL };

static const Key keys[] = {
	/* modifier                     key            function                argument */
	/* Personal Keys */
	{ MODKEY,                       XK_e,          spawn,                  {.v = emacs } },
	{ MODKEY|ShiftMask,             XK_j,          spawn,                  {.v = musPause } },
	{ MODKEY|ShiftMask,             XK_l,          spawn,                  {.v = musNext } },
	{ MODKEY|ShiftMask,             XK_h,          spawn,                  {.v = musPrev } },
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn,       {.v = sndUp } },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn,       {.v = sndDown} },
	...
	#if VANITYGAPS_PATCH
	{ Mod4Mask,                     XK_equal,      incrgaps,               {.i = +1 } },
	{ Mod4Mask,                     XK_minus,      incrgaps,               {.i = -1 } },
	{ Mod4Mask|ShiftMask,           XK_equal,      defaultgaps,            {0} },
	#endif // VANITYGAPS_PATCH
	#if ALT_TAB_PATCH
